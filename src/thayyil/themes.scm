(define-module (thayyil themes)
  #:use-module (ice-9 match)
  #:use-module (guix gexp)
  #:use-module (farg theme)
  #:use-module (farg colors)
  #:use-module (farg source)
  #:use-module (thayyil wallpapers)
  #:export (
            thayyil-theme-light
            thayyil-theme-dark
            thayyil-farg-palette))

(define* (thayyil-theme-light
          #:key (wallpaper #f))
  (farg-source
   (theme
    (farg-theme
...
(define (thayyil-farg-palette palette)
  (define red
