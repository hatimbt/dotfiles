...
(define-public neovim-lspconfig
  (package
    ...
    (description
     "This Neovim package provides the canonical configurations for the Neovim builtin LSP
client.")
...
(define-public neovim-rustaceanvim
  (package
    ...
    (arguments
     `(#:install-plan '(("doc" "share/nvim/site/pack/guix/start/rustaceanvim/")
                        ("lua" "share/nvim/site/pack/guix/start/rustaceanvim/")
                        ("ftplugin"
                         "share/nvim/site/pack/guix/start/rustaceanvim/"))))
...
fork of rust-tools.nvim.")
    (description
     "This plugin automatically configures the rust-analyzer builtin
...
(define-public neovim-lsp-zero
  (let ((commit "14c9164413df4be17a5a0ca9e01a376691cbcaef")
    ...
    (package
      ...
      (arguments
       (list
        #:plugin-name "lsp-zero"))
      (home-page "https://github.com/VonHeikemen/lsp-zero.nvim")
      (synopsis
       "A starting point to setup some lsp related features in neovim.")
      (description
       "Collection of functions that will help you setup Neovim's LSP
...
(define-public neovim-cmp
  (let ((commit "04e0ca376d6abdbfc8b52180f8ea236cbfddf782")
    ...
    (package
      ...
      (description
       "A completion engine for neovim written in Lua. Completion
...
(define-public neovim-cmp-lsp
  (let ((commit "5af77f54de1b16c34b23cba810150689a3a90312")
    ...
    (package
      ...
      (description
       "This plugin provides an LSP backend for the @code{neovim-cmp} plugin.")
      (license license:expat))))
...
(define-public neovim-modus-themes
  (package
    ...
    (arguments
     (list
      #:plugin-name "modus-themes.nvim"))
    (home-page "https://github.com/miikanissi/modus-themes.nvim")
    (synopsis
     "Highly accessible themes for Neovim, conforming with the highest
...
(define-public neovim-registers
  (package
    ...
    (arguments
     (list
      #:plugin-name "registers.nvim"))
    (home-page "https://github.com/tversteeg/registers.nvim")
    (synopsis "Neovim plugin to preview the contents of the registers")
    (description
     "This Neovim plugin adds an interactive and visually pleasing UI for selecting what register item to paste or use next. ")
    (license license:gpl3)))
...
structures")
    (description
     "Neo-tree is a Neovim plugin to browse the file system and
